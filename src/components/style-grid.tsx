        ...
        >
          ...
          >
            <div className="relative aspect-[16/9]">
              {/* 区分表示を追加 */}
              <div className="absolute top-0 left-0 right-0 bg-black/50 backdrop-blur-sm p-4 z-10 text-center">
                <h2 className="text-3xl font-bold text-futuristic-neon tracking-wider transform hover:scale-105 transition-transform duration-300">
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-black/50 backdrop-blur-sm p-4">
              <h3 id="modal-title" className="text-xl font-bold text-futuristic-accent">{selectedStyle.name}</h3>
